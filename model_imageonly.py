...
class ImgTok(nn.Module):
    def __init__(self, patch_size: int, 
        ...
        self.seq_length = self.num_patches + self.num_tokens
    ...
    def encode(self, input):
        ...
        tokenizer_input = torch.cat([img_patches, img_learnable], dim=1) #B x (hw + N) x D
    ...
    def decode(self, text, image_tokens):
        ...
        detokenizer_input = torch.cat([patch_tokens, image_token_proj], dim=1)  #B x (hw + N) x D
